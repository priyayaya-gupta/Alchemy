...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // Admin APIs sirf ADMIN ke liye
        .requestMatchers("/api/admin/**").hasRole("ADMIN")

        // Sirf ADMIN documents delete kar sakta hai
        // Ye rule generic /api/files/** rule se pehle hona chahiye
        .requestMatchers(HttpMethod.DELETE, "/api/files/**")
        .hasRole("ADMIN")

        // Query aur baaki file operations USER + ADMIN dono kar sakte hain
        .requestMatchers(
                "/api/query",
                "/api/query/**",
                "/api/files",
